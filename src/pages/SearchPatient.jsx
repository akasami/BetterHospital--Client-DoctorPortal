  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Breadcrumbs title="Patient" breadcrumbItem="Search Patient" />
        ...
        <Row>
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Enter the Patient Name to search for the required patient.
                </p>
          ...
          {searchfound?<div><br/><LatestTransaction /></div>:null}    
        </Row>
      </div>
    </React.Fragment>
  );
