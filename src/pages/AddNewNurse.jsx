...
import img4 from "../../src/assets/images/nurse.jpg";
...
const optionBachelors = [
  {
    label: "Bs",
    options: [
      { label: "Bachelor of Science in Nursing", value: "Bachelor of Medicine and Surgery" },
      { label: "Master of Science in Nursing", value: "Bachelor of Dental Surgery" },
      { label: "Others", value: "Others" },
    ],
  },
];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Breadcrumbs title="Nurse" breadcrumbItem="Add Nurse" />
        ...
        <Row>
          <Col xl="8">
            <Card>
              <CardBody>
                ...
                <Row>
                    <Col md="6">
                    <Label htmlFor="validationCustom01">Profile Picture</Label>
                    <div className="mb-3">
          ...
          <Col xl="8">
                ...
                <p className="card-title-desc">
                  Enter the information of the doctor in the given below form.
                </p>
                  ...
                  <Row>
                    <Col md="6">
                      <div className="mb-3">
                        ...
                        <Select
                          value={bachelor}
                          onChange={setBachelor}
                          options={optionBachelors}
                          classNamePrefix="select2-selection"
                        />
                      </div>
                    </Col>
