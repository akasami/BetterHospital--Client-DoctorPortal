        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li><Link to="/addnewappointment">{props.t("Previous Appointments")}</Link></li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li><Link to="/viewpatient">{props.t("View My Patients")}</Link></li>
                <li><Link to="/searchpatient">{props.t("Search Patient")}</Link></li>
